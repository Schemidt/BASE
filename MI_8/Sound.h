...
Определяет структуру SOUNDREAD и класс Sound
*/
...
#pragma pack ( push, 1 )
/*!
\brief  Протокол обмена с USPO
\author Калюжный С.В.
\version 1.2

*Структура предназначена для обмена данными между программами BASE и USPO
*Содержит в себе набор основных переменных определяющих состояние вертолета в момент времени time
*/
struct SOUNDREAD {
    ...
    char p_nar_c13;             //!< Признак применения НАР С-13, 1-левый борт,2-правый борт,3-оба борта
    ...
    float reduktor_hv_obor;     //!< Редуктор хвостовой обороты, 0..100 !!!ПЕРЕГРУЗКА
