...
public:
	...
	static int redCount;/*!< Переменная для количества инициализированных редукторов в программе */
	double phase;//!<Фаза для редукторов, чтобы их звуки не сливались(0-1, смещаем на 0.33 для каждого нового объекта, т.е. запускаем с 33% * n процентов длительности)
	int redNum;//!<Номер редуктора
