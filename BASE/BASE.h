...
public:
	...
	static vector<double> vectorHigh, vectorVy, vectorVx, vectorAcc, vectorStep, vectorTangaz, vectorTime, vectorRedTurn;//!<Массивы для хранения значений переменных за некоторое время (определено условием в main), для расчета производных
